            ...
            <div class="flex h-16 justify-between items-center">
                <div class="flex items-center">
                    ...
                    <nav class="hidden h-16 space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <a href="{{route('courses')}}"
                            class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-base font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition">Courses
                        </a>
                        <a href="courses.html"
                ...
                <div class="flex items-center">
                    ...
                    @if (Auth::check())
                        ...
                        @else
                            <a href=""
                                class="ml-4 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500">Submit course</a>
                        @endif

                        <form method="POST" action="{{ route('logout') }}">@csrf
                            <button type="submit"
                                class="ml-8 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500">Logout</button>
                        </form>
                    @else
                        <a href="{{ route('login') }}"
            ...
            <div class="w-full">
                ...
                <div class="container flex justify-between pb-[50px]">
                    <div>
                        ...
                        <ul class="mt-5">
                            <li class="mb-2">
                                <a href="{{route('archive', ['series', 'javascript'])}}"
                                    class="text-links text-gray-100 text-base before:text-gray-100">JavaScript</a>
                            </li>
                            <li class="mb-2">
                            ...
                            <li class="mb-2">
                                <a href="{{route('archive', ['series', 'wordpress'])}}"
                                    class="text-links text-gray-100 text-base before:text-gray-100">WordPress</a>
                            </li>
                            <li class="mb-2">
                                <a href="{{route('archive', ['series', 'vuejs'])}}"
                    ...
                    <div>
                        ...
                        <ul class="mt-5">
                            <li class="mb-2">
                                <a href="{{route('archive', ['duration', '1-5 hours'])}}" class="text-links text-gray-100 text-base before:text-gray-100">1-5
                                    hours</a>
                            </li>
                            <li class="mb-2">
                                <a href="{{route('archive', ['duration', '5-10 hours'])}}" class="text-links text-gray-100 text-base before:text-gray-100">5-10
                                    hours</a>
                            </li>
                            <li class="mb-2">
                                <a href="{{route('archive', ['duration', '10-plus hours'])}}" class="text-links text-gray-100 text-base before:text-gray-100">10+
                                    hours</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="mt-5">
                            ...
                            <li class="mb-2">
                                <a href="{{route('archive', ['level', 'intermidiate'])}}"
                ...
                <div class="mx-auto container flex items-center justify-between gap-5 pb-8">
                    ...
                    <p class="text-sm  text-center text-[#E5E5E580] leading-5 z-50 relative"> Developed by <a
                            href="https://twitter.com/phpfour" target="_blank"
                            class="hover:underline font-medium">Eshita</a></p>
                    <span></span>
                </div>
            </div>
        </div>
