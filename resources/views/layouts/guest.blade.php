            ...
            <div class="w-full">
                ...
                <div class="container flex justify-between pb-[50px]">
                    ...
                    <div>
                        ...
                        <ul class="mt-5">
                            <li class="mb-2">
                                <a href="#" class="text-links text-gray-100 text-base before:text-gray-100">1-5
                                    hours</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-links text-gray-100 text-base before:text-gray-100">5-10
                                    hours</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-links text-gray-100 text-base before:text-gray-100">10+
                                    hours</a>
                            </li>
                        </ul>
                    </div>
